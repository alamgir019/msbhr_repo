    ...
    <div class="empTrainForm">
        <div id="formhead2">
            <div style="width: 97%; float: left;">
                Confirmation Appraisal (For All)</div>
                    ...
                    <ContentTemplate>
                        ...
                        <fieldset>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtActivityName" runat="server" Width="330px"></asp:TextBox>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDesc" runat="server" Width="330px"></asp:TextBox>
                                    </td>
                                    <td>
                        ...
                        <fieldset>
                            <legend>Major Difficulties</legend>
                            <table>
                                <tr>
                                    <td class="textlevelleft">
                                        Difficulties
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtDiff" runat="server" Width="330px"></asp:TextBox>
                                    </td>
                                    <td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="textlevelleft">
                                    Promptness in executing responsibilities:
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TextBox11" runat="server" TextMode="MultiLine" Width="250px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="textlevelleft">
                                    Approved/Comments by MD/CMC:
                                </td>
                                <td>
