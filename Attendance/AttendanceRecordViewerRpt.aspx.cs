...
public partial class Attendance_AttendanceRecordViewerRpt : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (strVal.Length == 4)
            {
                DataTable dtAttnAdj = objAdjMgr.GetData(strVal[1], strVal[2], "4", strVal[0], strVal[3], "0", "0");
