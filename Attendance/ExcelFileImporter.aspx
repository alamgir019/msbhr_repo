<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="ExcelFileImporter.aspx.cs" Inherits="Attendance_ExcelFileImporter" Title="Excel File Importer" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="formStyle" style="height: 520px;">
        <div id="formhead3">
            Excel File Importer</div>
                ...
                <td style="width: 50%;">
                    <fieldset>
                        ...
                        <div style="overflow: scroll; height: 350px; width: 99%; margin-left: 10px; margin-top: 10px;">
                            <asp:GridView ID="grTextData" runat="server" AutoGenerateColumns="false"
                                Width="120%">
