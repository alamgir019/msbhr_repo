<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="AttnRecords.aspx.cs" Inherits="AttnRecords" Title="Attendance Records" %>
...
{   
 ...
 <div class="formStyle">
    <div id="formhead3">Attendance Records</div>
    <div class="MsgBox">
                ...
                <tr >
                    <td colspan="2" style="padding-left:40px;">
                         <asp:GridView ID="grEmpList" runat="server" AutoGenerateColumns="False"
                                DataKeyNames="EmpId,FullName,SupervisorId"
