<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="JobTitleSetup.aspx.cs" Inherits="EIS_JobTitleSetup" Title="Job Title Setup" %>
...
<asp:Content ID="MaiContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Job Title Name :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDesigation" runat="server" Width="486px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            <asp:GridView ID="grDesigation" runat="server" DataKeyNames="JobTitleId,IsActive"
