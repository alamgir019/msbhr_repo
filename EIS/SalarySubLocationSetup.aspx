<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="SalarySubLocationSetup.aspx.cs" Inherits="EIS_SalarySubLocationSetup"
...
<asp:Content ID="MaiContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Salary Sub Loc. Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            <asp:GridView ID="grDesigation" runat="server" DataKeyNames="SalSubLocId,IsActive"
