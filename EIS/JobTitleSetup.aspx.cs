...
public partial class EIS_JobTitleSetup : System.Web.UI.Page
{
    //String strName;
    ...
    {
        dtDesigation = objMasMgr.SelectJobTitle(0);
    ...
    private void SaveData(string IsDelete)
    {
        ...
        try
        {
            ...
            if (hfIsUpadate.Value == "N")
                lngID = objDB.GerMaxIDNumber("JobTitle", "JobTitleId");
            else
            ...
            MasMgr.InsertJobTitle(objCnt, hfIsUpadate.Value, IsDelete, (ChkIsActive.Checked == true ? "N" : "Y"));
