<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="EmpHRInfo.aspx.cs" Inherits="Back_Office_EmpHRInfo" Title="Employee HR Information" %>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlProject" runat="server" Width="300px" CssClass="textlevelleft">
                                    </asp:DropDownList>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlSubDept" CssClass="textlevelleft" runat="server" Width="300px">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    &nbsp;
                ...
                <div style="background-color: #C8C8C8;">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRetirementDate" runat="server" Width="89px"></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtSeparationDate" runat="server" Width="89px" Enabled="true"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <asp:DropDownList ID="ddlSepType" runat="server" Width="250px" CssClass="textlevelleft">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
                            ...
                            <td>
                                <asp:TextBox ID="txtSeparationReason" runat="server" Width="295px" Font-Names="Arial"></asp:TextBox>
                            </td>
                            <td>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNotRehireReason" runat="server" Width="295px" Font-Names="Arial"></asp:TextBox>
                            </td>
                            <td>
                                &nbsp;
                            </td>
                ...
                <div style="background-color: #F2DBDB;">
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtOtherBenefit" runat="server" Font-Names="Arial" Width="295px">N/A</asp:TextBox>&nbsp;
                            </td>
                            <td class="textlevel">
                                Remarks :
                            </td>
