<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="DivisionSetup.aspx.cs" Inherits="EIS_DivisionSetup" Title="Division Setup" %>
            ...
            <fieldset>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDivisionShortName" runat="server" Width="100px"></asp:TextBox>
                        </td>
        ...
        <div style="margin-left: 10px; margin-right: 10px; margin-top: 10px;">
            <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="100%"
                ...
                <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel1" Width="100%">
                    ...
                    <ContentTemplate>
                        <div style="width: 100%; height: 240px; overflow: scroll;">
                            <asp:GridView ID="grLocation" runat="server" DataKeyNames="PostingDistId,PostingDivId"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PostingDistName" HeaderText="District Name">
                ...
                <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1" Width="100%">
                    ...
                    <ContentTemplate>
                        <div style="width: 100%; height: 240px; overflow: scroll;">
                            <asp:GridView ID="grDivision" runat="server" DataKeyNames="PostingDivId,IsActive" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PostingDivName" HeaderText="Division Name">
