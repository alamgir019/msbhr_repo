<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="LocationCategorySetup.aspx.cs" Inherits="EIS_LocationCategorySetup" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" 
                                Text="Location Category Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grLocCat" runat="server" DataKeyNames="LocCatId,IsActive"
                AutoGenerateColumns="False" EmptyDataText="No Record Found" Font-Size="9px" Width="100%"
                OnRowCommand="grLocCat_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="LocCatName" HeaderText="Location Category Name">
