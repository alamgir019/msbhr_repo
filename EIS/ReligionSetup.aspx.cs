...
public partial class EIS_ReligionSetup : System.Web.UI.Page
{
    ...
    {
        dtDesigation = objMasMgr.SelectReligionList(0);
    ...
    private void SaveData(string IsDelete)
    {
        ...
        try
        {
            ...
            if (hfIsUpadate.Value == "N")
                lngID = objDB.GerMaxIDNumber("ReligionList", "ReligionId");
            else
            ...
            MasMgr.InsertReligionList(objCnt, hfIsUpadate.Value, IsDelete, (ChkIsActive.Checked == true ? "N" : "Y"),this.txtNumOfBasic.Text.ToString(),this.txtPercentage.Text.ToString());
    ...
    protected void grDesigation_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (_commandName)
        {
            case ("DoubleClick"):
                ...
                txtNumOfBasic.Text = Common.CheckNullString(grDesigation.SelectedRow.Cells[2].Text.Trim ());
                txtPercentage.Text =Common.CheckNullString( grDesigation.SelectedRow.Cells[3].Text.Trim ());
