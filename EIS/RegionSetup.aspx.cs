...
public partial class EIS_RegionSetup : System.Web.UI.Page
{
    ...
    {
        dtRegion = objMasMgr.SelectRegion();
        grList.DataSource = dtRegion;
        grList.DataBind();
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMsg.Text = "Select a region first from the list then try to delete.";
        }
