<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="BloodGroupSetup.aspx.cs" Inherits="EIS_BloodGroupSetup" Title="Blood Group Setup" %>
...
<asp:Content ID="MaiContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Blood Group Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            <asp:GridView ID="grDesigation" runat="server" DataKeyNames="BloodGroupId,IsActive"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="BloodGroupName" HeaderText="Blood Group Name">
