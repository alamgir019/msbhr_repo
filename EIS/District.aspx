<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="District.aspx.cs" Inherits="DistrictSetup" Title="District" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="District Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grDistrict" runat="server" DataKeyNames="PostingDistId,IsActive"
                AutoGenerateColumns="False" EmptyDataText="No Record Found" Font-Size="9px" Width="100%"
                OnRowCommand="grDistrict_RowCommand">
