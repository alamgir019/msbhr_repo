<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="RelationSetup.aspx.cs" Inherits="EIS_RelationSetup" Title="Relation Setup" %>
...
<asp:Content ID="MaiContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Relation Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            <asp:GridView ID="grDesigation" runat="server" DataKeyNames="RelationId,IsActive"
