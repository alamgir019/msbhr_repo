<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="EmployeeType.aspx.cs" Inherits="EIS_EmployeeType" Title="Employee Type" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="officeSetup">
        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Employee Type :"></asp:Label></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkInActive" runat="server" CssClass="textlevelleft" 
                                Text="Make Inactive" /></td>
                        <td>
                        </td>
                    </tr>
                </table>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grEmpTypeStatus" runat="server" DataKeyNames="EmpTypeID,IsActive"
