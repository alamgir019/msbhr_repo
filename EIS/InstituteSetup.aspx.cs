...
public partial class EIS_InstituteSetup : System.Web.UI.Page
{
    ...
    {
        dtList = objEmpMgr.SelectInstitute(0, "A");
    ...
    private void SaveData(string IsDelete)
    {
        try
        {
            if (hfIsUpdate.Value == "Y")
                ...
                hfId.Value = Common.getMaxId("InstituteList", "InstituteId");
            ...
            objEmpMgr.InsertInstitute(objCommonSetup, hfIsUpdate.Value, IsDelete);
