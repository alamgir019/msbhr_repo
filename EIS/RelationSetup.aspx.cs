...
public partial class EIS_RelationSetup : System.Web.UI.Page
{
    //String strName;
    ...
    {
        dtDesigation = objMasMgr.SelectRelationList(0);
    ...
    private void SaveData(string IsDelete)
    {
        ...
        try
        {
            ...
            if (hfIsUpadate.Value == "N")
                lngID = objDB.GerMaxIDNumber("RelationList", "RelationId");
            else
            ...
            MasMgr.InsertRelationList(objCnt, hfIsUpadate.Value, IsDelete, (ChkIsActive.Checked == true ? "N" : "Y"));
