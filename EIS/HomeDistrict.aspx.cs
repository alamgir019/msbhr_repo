...
public partial class HomeDistrict : System.Web.UI.Page
{
    ...
    {
        dtDistrict = objMasMgr.SelectHomeDistrict(0);
    ...
    private void SaveData(string IsDelete)
    {
        ...
        try
        {
            ...
            Desigation objCnt = new Desigation(lngID.ToString(), txtDistrict.Text.Trim(),"N", Session["USERID"].ToString(), Common.SetDateTime(DateTime.Now.ToString()), Session["USERID"].ToString(), Common.SetDateTime(DateTime.Now.ToString()), "HRD", "N", "N", (ChkIsActive.Checked == true ? "N" : "Y"));

            MasMgr.InsertHomeDistrict(objCnt, hfIsUpadate.Value, IsDelete);
