...
public partial class EIS_ResultSetup : System.Web.UI.Page
{
    ...
    {
        dtList = objEmpMgr.SelectResult(0, "A");
    ...
    private void SaveData(string IsDelete)
    {
        try
        {
            if (hfIsUpdate.Value == "Y")
                ...
                hfId.Value = Common.getMaxId("ResultList", "ResultId");
            ...
            objEmpMgr.InsertResult(objCommonSetup, hfIsUpdate.Value, IsDelete);
