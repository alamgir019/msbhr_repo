<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="FileUpload.aspx.cs" Inherits="EIS_FileUpload" Title="File Upload" %>
            ...
            <fieldset>
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDesignation" runat="server" Width="250px" CssClass="textlevel">
                            </asp:DropDownList>
                        </td>
                        <td class="textlevel">
                            Place of Posting :
                        ...
                        <td>
                            <asp:DropDownList ID="ddlOffice" runat="server" Width="250px" CssClass="textlevel">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
