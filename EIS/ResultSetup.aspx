<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="ResultSetup.aspx.cs" Inherits="EIS_ResultSetup" Title="Result Setup" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="officeSetup">
        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Result Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grList" runat="server" DataKeyNames="ResultId" AutoGenerateColumns="False"
