...
public partial class EIS_SalarySubLocationSetup : System.Web.UI.Page
{
    //String strName;
    ...
    {
        dtDesigation = objMasMgr.SelectSalarySubLocation(0);
    ...
    private void SaveData(string IsDelete)
    {
        ...
        try
        {
            ...
            if (hfIsUpadate.Value == "N")
                lngID = objDB.GerMaxIDNumber("SalarySubLocation", "SalSubLocId");
            else
            ...
            MasMgr.InsertSalarySubLocation(objCnt, hfIsUpadate.Value, IsDelete, (ChkIsActive.Checked == true ? "N" : "Y"));
