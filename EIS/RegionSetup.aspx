<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="RegionSetup.aspx.cs"
 Inherits="EIS_RegionSetup" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Region Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grList" runat="server" DataKeyNames="RegionId,IsActive"
