<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="NomineeDeath.aspx.cs" Inherits="EIS_NomineeDeath" Title="Death Beneficiary Nominee" %>
        ...
        <div id="PayrollConfigInner">
            ...
            <fieldset><legend>Nominee</legend> 
                 <table>
                     ...
                     <tr>
                        <td class="textlevel">Benefit :</td>
                        <td class="textlevelleft">
                            <asp:TextBox ID="txtBenefit" runat="server" MaxLength="3" Width="20%" 
                     ...
                     <tr><td class="textlevel">Death Beneficiary :</td>
            ...
            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Custom,Numbers"
                    ValidChars="0123456789" TargetControlID="txtBenefit">
