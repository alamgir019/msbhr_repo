<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="GroupListSetup.aspx.cs" Inherits="KPI_GroupListSetup" %>
...
<script language="javascript" type="text/javascript">
    ...
    <div class="officeSetup">
        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Group Title :"></asp:Label>
                        </td>
                        <td colspan="3">
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grGroup" runat="server" DataKeyNames="GroupId" AutoGenerateColumns="False"
                EmptyDataText="No Record Found" Font-Size="9px" OnRowCommand="grGroup_RowCommand"
                OnSelectedIndexChanged="grGroup_SelectedIndexChanged" Width="99%">
