                ...
                <div id="leaveApplicaionFormInner" style="margin-top: 5px;">
                    <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" Height="590px">
                        <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                            <HeaderTemplate>Leave Application Form</HeaderTemplate>
                            <ContentTemplate>
                                <div style="background-color: #EFF3FB; border: solid 1px #3E506C;">
                                    <table>
                                        <tr>
                                            <td><asp:Label ID="Label7" runat="server" CssClass="textlevel" Text="Emp Id : "></asp:Label></td>
                                            <td>
                                                <asp:TextBox ID="txtEmpId" runat="server" Height="16px" onkeyup="ToUpper(this)" Width="80px"></asp:TextBox>
                                                <asp:ImageButton ID="imgBtnSearch" runat="server" CausesValidation="False" Height="19px" 
                                                    ImageUrl="~/Images/Search_Icon.jpg" OnClick="imgBtnSearch_Click" Width="21px"></asp:ImageButton>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEmpId" 
                                                    ErrorMessage="*" Font-Bold="True" Font-Size="X-Large" Height="16px"></asp:RequiredFieldValidator>
                                            </td>
                                            <td></td>
                                        </tr>
                                    </table>
                                    <table>
                                        <tr>
                                            <td><asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Applicant : "></asp:Label></td>
                                            <td><asp:Label ID="lblName" runat="server" Width="600px"></asp:Label></td>
                                            <td><asp:Label ID="Label15" runat="server" CssClass="textlevel" Text="Supervisor :"></asp:Label></td>
                                            <td><asp:Label ID="lblSupervisor" runat="server" Width="600px"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td><asp:Label ID="Label5" runat="server" CssClass="textlevel" Text="Leave Package : "></asp:Label></td>
                                            <td><asp:Label ID="lblEmpType" runat="server" Width="211px"></asp:Label></td>
                                        </tr>
                                    </table>
                                    ...
                                    <fieldset style="margin-top: 5px;">
                                        <div style="width: 100%">
                                            ...
                                            height: 400px;">
                                                ...
                                                <tr><td>
                                                <div style="float: left; margin: 5px 0px 0px 5px; width: 98%; height: 325px;">
                                                    <asp:GridView 
                                                    ...
                                                    OnSelectedIndexChanged="grLeaveStatus_SelectedIndexChanged" PageSize="7" Width="100%">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center; height: 35px;">
                                                            <hr /><hr />
                                                            <asp:Button ID="btnLeaveHistroy" runat="server" CausesValidation="False" OnClick="btnLeaveHistroy_Click" Text="Show My Leave History" Width="240px"></asp:Button>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div style="width: 29%; float: left; margin-left: 1%; background-color: #F2DBDB; border: solid 1px Gray; height: 400px;">
                                                <table style="width: 100%;"></table>
                                                <table width="100%">
                                                    <tr>
                                                        <td colspan="3" style="font-size: 14px; font-weight: bold; text-align: left; border-bottom: solid 1px Gray;">Complete Leave Application</td>
                                                    </tr>
                                                    <tbody>
                                                        <tr>
                                                            <td class="textlevel">App. Date :</td>
                                                            <td>
                                                                <asp:TextBox ID="txtAppDate" runat="server" Height="16px" ReadOnly="True" Width="80px"></asp:TextBox>
                                                            ...
                                                            <td></td>
                                                            <td style="width: 3px">
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" __designer:wfdid="w698" ControlToValidate="txtAppDate" CssClass="validator" ErrorMessage="Invalid" 
                                                        ...
                                                        <tr>
                                                            <td class="textlevel">Date From :</td>
                                                            <td><asp:TextBox ID="txtFromDate" runat="server" __designer:wfdid="w699" MaxLength="10" Width="80px"></asp:TextBox>
                                                                <a href="javascript:NewCal('<%= txtFromDate.ClientID %>','ddmmyyyy')">
                                                                <img alt="Pick a date" height="16" src="../images/cal.gif" 
                                                                style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" 
                                                                width="16" /></a>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" __designer:wfdid="w747" ControlToValidate="txtFromDate" 
                                                                ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                            </td>
                                                            <td><asp:Panel ID="PanelFrom" runat="server"></asp:Panel></td>
                                                            <td style="width: 3px">
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" __designer:wfdid="w700" ControlToValidate="txtFromDate" CssClass="validator" ErrorMessage="Invalid"
                                                                     ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$" 
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textlevel">Date To :</td>
                                                            <td><asp:TextBox ID="txtToDate" runat="server" __designer:wfdid="w701" MaxLength="10" Width="80px"></asp:TextBox>
                                                                <a href="javascript:NewCal('<%= txtToDate.ClientID %>','ddmmyyyy')">
                                                                    <img alt="Pick a date" height="16" src="../images/cal.gif" 
                                                                    style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" 
                                                                    width="16" />
                                                                </a>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" __designer:wfdid="w748" ControlToValidate="txtToDate" 
                                                                    ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                            </td>
                                                            <td><asp:Panel ID="PanelTo" runat="server"></asp:Panel></td>
                                                            <td style="width: 3px"><asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                                                                __designer:wfdid="w702" ControlToValidate="txtToDate" CssClass="validator" ErrorMessage="Invalid" 
                                                                ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$" 
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                <asp:DropDownList ID="ddlHalfDay" runat="server" __designer:wfdid="w703" AutoPostBack="True" 
                                                                CausesValidation="True" CssClass="textlevelleft" 
                                                            OnSelectedIndexChanged="ddlLeaveType_SelectedIndexChanged" Width="84px">
                                                        ...
                                                        <tr>
                                                            <td class="textlevel">Resume Date :</td>
                                                            <td>
                                                                <asp:TextBox ID="txtResumeOn" runat="server" __designer:wfdid="w704" MaxLength="10" Width="80px"></asp:TextBox>
                                                                <a href="javascript:NewCal('<%= txtResumeOn.ClientID %>','ddmmyyyy')">
                                                                    <img alt="Pick a date" height="16" src="../images/cal.gif" 
                                                                        style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" width="16" />
                                                                </a>
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" __designer:wfdid="w749" ControlToValidate="txtResumeOn" 
                                                                    ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: 3px">
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" __designer:wfdid="w705" ControlToValidate="txtResumeOn" CssClass="validator" ErrorMessage="Invalid" 
                                                                ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$" 
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                __designer:wfdid="w706" AutoPostBack="True" CausesValidation="True" CssClass="textlevelleft" 
                                                                OnSelectedIndexChanged="ddlLeaveType_SelectedIndexChanged" Width="110px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="btnCalculate" runat="server" __designer:wfdid="w707" 
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td colspan="2">
                                                                <asp:Label ID="Label14" runat="server" __designer:wfdid="w708" 
                                                        ...
                                                        <tr>
                                                            <td></td>
                                                            <td>
                                                                <asp:TextBox ID="LAv" runat="server" __designer:wfdid="w710" 
                                                        ...
                                                        <tr>
                                                            <td class="textlevelshort" colspan="4">
                                                                <asp:Label ID="lblMsg2" runat="server" __designer:wfdid="w712" CssClass="msglabel" Width="200px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="textlevelshort" colspan="4">
                                                                <asp:Label ID="lblMsg3" runat="server" __designer:wfdid="w713" CssClass="msglabel" Width="200px"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr><td class="textlevelshort" colspan="4"></td></tr>
                                                        <tr>
                                                            <td colspan="4" style="height: 115px"><hr /><hr />
                                                                <asp:Button ID="btnReload" runat="server" CausesValidation="False" OnClick="btnReload_Click" Text="Refresh" Width="95%"></asp:Button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <asp:HiddenField ID="hfLEnjoyed" runat="server" __designer:wfdid="w714"></asp:HiddenField>
                                            ...
                                            <div style="width: 30%; float: left; margin-left: 1%; background-color: #C2D69B; border: solid 1px Gray; height: 400px;">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="font-size: 14px; font-weight: bold; text-align: left; border-bottom: solid 1px Gray;">Fill in Remarks</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="textlevelleft" style="height: 20px" valign="bottom">
                                                            Reason (In case of TOIL application please mention which date/s and why you have worked)</td></tr>
                                                    <tr>
                                                        <td>
                                                            <asp:TextBox ID="txtLeaveReason" runat="server" Height="94px" MaxLength="1000" TextMode="MultiLine" Width="98%"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr><td class="textlevelleft" style="height: 20px" valign="bottom">Leave Address</td></tr>
                                                    <tr>
                                                        <td><asp:TextBox ID="txtLeaveAdd" runat="server" Height="94px" MaxLength="150" TextMode="MultiLine" Width="98%"></asp:TextBox></td>
                                                    </tr>
                                                    <tr><td class="textlevelleft" style="height: 23px" valign="bottom">Contact Number</td></tr>
                                                    <tr><td><asp:TextBox ID="txtPhone" runat="server" Height="17px" MaxLength="100" Width="98%"></asp:TextBox></td></tr>
                                                    <tr>
                                                        <td style="height: 70px;">
                                                            <hr /><hr />
                                                            <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Email Application to My Supervisor" Width="95%" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Leave Cancel" Visible="False" />
                                    <asp:Panel ID="pnlEmpList" runat="server">
                                        <fieldset>
                                            <legend>Admin Service</legend>
                                            <table>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 3px"><asp:DropDownList ID="ddlEmpList" runat="server" Width="500px"></asp:DropDownList></td>
                                                    <td><asp:Button ID="btnEmpDetails" runat="server" CausesValidation="False" OnClick="btnEmpDetails_Click" Text="Load Employee"></asp:Button></td>
                                                </tr>
                                            </table>
                                        </fieldset> 
                                    </asp:Panel>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label4" runat="server" CssClass="textlevel" Text="Office : " Visible="False"></asp:Label>
                                            </td>
                                            <td><asp:Label ID="lblDept" runat="server" Visible="False" Width="211px"></asp:Label></td>
                                            <td style="width: 2px"><asp:Label ID="Label6" runat="server" CssClass="textlevel" Text="Designation :" Visible="False"></asp:Label></td>
                                            <td><asp:Label ID="lblDesig" runat="server" Visible="False" Width="211px"></asp:Label></td>
                                            <td style="width: 3px"></td><td style="width: 3px"></td>
                                        </tr>
                                    </table>
