...
public partial class EmpLeaveProfile : System.Web.UI.Page
{
    ...
    protected void SearchEmployee()
    {
        if (string.IsNullOrEmpty(txtEmpId.Text.Trim()) == false)
        {
            ...
            //}
            //else
            dtEmp = objEmpInfoMgr.SelectEmpInfoForLeave(txtEmpId.Text.Trim());
            ...
            {
                lblMsg2.Text = "";
                this.FillEmpWithLeaveInfo(txtEmpId.Text.Trim(), dtEmp.Rows[0]["Gender"].ToString(),
    ...
    protected void grEmpList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case ("ViewClick"):
                txtEmpId.Text = grEmpList.SelectedRow.Cells[1].Text.Trim();
                SearchEmployee();
                break;
