...
public class GradeEquiv
{
    ...
    private string _IsOTEntitle;

    public string IsOTEntitle
    {
        get { return _IsOTEntitle; }
        set { _IsOTEntitle = value; }
    }

    public GradeEquiv(string GradeID, string GradeName, string isDeleted, string InsertedBy, string InsertedDate, 
        string IsUpdate, string IsDelete, string IsActive,string IsOTEntitle)
    {
