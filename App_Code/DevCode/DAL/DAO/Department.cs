...
public class Department
{
    ...
    public string StrLocationID
    {
        ...
        set { _strLocationID = value; }
    }

    public Department(string DeptId, string DeptName, string DeptDesc, string isDeleted, string InsertedBy, string InsertedDate, string UpdatedBy, string UpdatedDate, string LastUpdatedFrom, string IsUpdate, string IsDelete, string StrLocationID, string IsActive)
    {
        this.DeptId = DeptId;
