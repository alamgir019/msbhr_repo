...
public class clsEmpInfoHr
{
    ...
    public string SeparateTypeId { get; set; }
    public string SeparateDate { get; set; }
    ...
    public string DateInGrade { get; set; }
    public string ActionName { get; set; }
    public string ActionDate { get; set; }
    public string SalPakId { get; set; }
    public string BonusPakId { get; set; }
    ...
    public string ProjectOfficeId { get; set; }
