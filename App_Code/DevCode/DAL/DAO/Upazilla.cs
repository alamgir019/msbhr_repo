...
/// <summary>
/// Summary description for Upazilla
/// </summary>
public class Upazilla
{
    private string _UpazillaID;

    public string UpazillaID
    {
        get { return _UpazillaID; }
        set { _UpazillaID = value; }
    }
    private string _UpazillaName;

    public string UpazillaName
    {
        get { return _UpazillaName; }
        set { _UpazillaName = value; }
    }
    ...
    public Upazilla(string UpazillaID, string UpazillaName, string isDeleted, string InsertedBy, string InsertedDate, string UpdatedBy, string UpdatedDate, string LastUpdatedFrom, string IsUpdate, string IsDelete)
	{
