...
public class Desigation
{
    ...
    public Desigation(string DesgID, string DesgName, string isDeleted, string InsertedBy, string InsertedDate, string UpdatedBy, string UpdatedDate,
        string LastUpdatedFrom, string IsUpdate, string IsDelete, string IsActive)
    {
        this.DesgID = DesgID;
    ...
    public Desigation(string DesgID, string DesgName, string ShortName, string isDeleted, string InsertedBy, string InsertedDate, string UpdatedBy, string UpdatedDate,
        string LastUpdatedFrom, string IsUpdate, string IsDelete, string IsActive)
    {
        this.DesgID = DesgID;
        this.DesgName = DesgName;
