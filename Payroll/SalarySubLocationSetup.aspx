<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="SalarySubLocationSetup.aspx.cs" Inherits="Payroll_SalarySubLocationSetup"
    Title="Salary Sub Location Setup" %>
        ...
        <div class="setupInner">
            <fieldset>
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Salary Sub Location :"></asp:Label></td>
                        <td>
