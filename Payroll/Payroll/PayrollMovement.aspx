<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="PayrollMovement.aspx.cs" Inherits="Payroll_Payroll_PayrollMovement"
        ...
        <div class="Div950">
            ...
            <fieldset>
                <div id="PrintMe" style="width: 99.99%; page-break-before: always; height: 100%;">
                    ...
                    <asp:UpdatePanel ID="UpdatePanelMeveText1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grMoveText" runat="server" AutoGenerateColumns="False" ShowHeader="false"
                                EmptyDataText="" Font-Size="10px" DataKeyNames="EMPID,ISPRINTTOPAYSLIP" Font-Names="Arial"
                                Width="99%" ShowFooter="false" OnRowCommand="grMoveText_RowCommand">
            ...
            <div id="DivCommand1" style="padding-top: 3px;">
                ...
                <div style="text-align: right;">
                    <asp:Button ID="btnPrintMovement" runat="server" Text="Print Movement Report" Width="200px"
                        CausesValidation="False" OnClick="btnPrintMovement_Click" Visible="False" />
                    <asp:Button ID="btnEditMovement" runat="server" Text="Edit Movement Report" Width="200px"
                        CausesValidation="False" OnClick="btnEditMovement_Click" Visible="False" />
                    <asp:Button ID="btnShowModal" runat="server" Text="Prapare Movement Report" Width="200px"
                        CausesValidation="False" Visible="False" />
                    <asp:Button ID="btnPrintBottom" runat="server" Text="Print" OnClientClick="printDiv('PrintMe')" />
                </div>
            </div>
            <div style="text-align: right;">
                <asp:UpdatePanel ID="UpdatePanelMeveText2" runat="server">
                    <ContentTemplate>
                        <asp:Panel Style="display: none" ID="PanelMeveText" runat="server" Width="500px"
                            CssClass="modalPopup" Height="160px">
                            <div style="font-weight: bold; font-size: 13px; background-image: url(../../Images/orengeBG.jpg);
                                width: 500px; color: white; background-repeat: repeat-x; height: 20px; text-align: left">
                                Input Movement History
                            </div>
                            <asp:HiddenField ID="hfMoveTextEmpID" runat="server"></asp:HiddenField>
                            <asp:HiddenField ID="hfMoveTextMonth" runat="server"></asp:HiddenField>
                            <asp:HiddenField ID="hfMoveTextYear" runat="server"></asp:HiddenField>
                            <asp:TextBox ID="txtMoveText" runat="server" Width="490px" Rows="4" TextMode="MultiLine"></asp:TextBox>
                            <div style="text-align: Left">
                                <asp:CheckBox ID="chkP2P" Text="PTP" runat="server" ToolTip="Posted To Payslip" Checked="False">
                                </asp:CheckBox>
                            </div>
                            <div class="DivCommand1">
                                <div class="DivCommandL">
                                    <asp:ImageButton ID="imgbtnSaveMoveText" runat="server" Width="30px" Height="30px"
                                        ImageUrl="~/Images/Ok.jpeg" OnClick="imgbtnSaveMoveText_Click"></asp:ImageButton>&nbsp;
                                </div>
                                <div class="DivCommandR">
                                    <div style="margin-top: 5px; vertical-align: top; height: 20px; text-align: right">
                                        <asp:ImageButton ID="imgbtnCloseMoveText" runat="server" Width="25px" Height="25px"
                                            ImageAlign="AbsMiddle" ImageUrl="~/Images/Close.png"></asp:ImageButton>
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>
                        <asp:Button ID="btnShowMoveTextModal" runat="server" Text="." CausesValidation="False"
                            Enabled="false" Visible="true"></asp:Button>
                        <cc1:ModalPopupExtender ID="ModalpopupextenderMoveText" runat="server" BackgroundCssClass="modalBackground"
                            CancelControlID="imgbtnCloseMoveText" DropShadow="True" DynamicServicePath=""
                            Enabled="True" PopupControlID="PanelMeveText" TargetControlID="btnShowMoveTextModal">
                        </cc1:ModalPopupExtender>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
            <div style="text-align: right;">
                <asp:Panel Style="display: none" ID="PnlMove" runat="server" Width="960px" Height="550px"
                    CssClass="modalPopup">
                    <div style="width: 960px; text-align: left; font-weight: bold; font-size: 13px; background-image: url(../../Images/orengeBG.jpg);
                        color: white; background-repeat: repeat-x; height: 20px">
                        Statement of Salary Movement
                    </div>
                    <div style="margin-top: 10px; width: 960px; background-color: #eff3fb; text-align: center">
                        <fieldset>
                            <asp:Label ID="lblMsgMoveStatement" runat="server" Text=""></asp:Label>
                        </fieldset>
                    </div>
                    <!--Grid view Code starts-->
                    <div style="margin-top: 10px; overflow: scroll; width: 960px; height: 420px; text-align: center">
                        <asp:GridView ID="grMovement" runat="server" Width="940px" DataKeyNames="" AutoGenerateColumns="False"
                            Font-Size="9px" EmptyDataText="No Record Found" ShowFooter="true">
                            <HeaderStyle BackColor="#B3CDE4" Font-Bold="True" HorizontalAlign="center" Font-Size="10px"
                                Font-Names="Tahoma"></HeaderStyle>
                            <SelectedRowStyle BackColor="#D1DDF1" ForeColor="#333333" CssClass="ListHeader" Font-Bold="True">
                            </SelectedRowStyle>
                            <AlternatingRowStyle BackColor="#EFF3FB"></AlternatingRowStyle>
                            <RowStyle Font-Size="10px" HorizontalAlign="right" Font-Names="Tahoma" />
                            <FooterStyle BackColor="#B3CDE4" Font-Bold="True" Font-Size="10px" Font-Names="Tahoma"
                                HorizontalAlign="right"></FooterStyle>
                            <Columns>
                                <asp:BoundField DataField="" HeaderText="Name of Month">
                                    <ItemStyle CssClass="ItemStylecss" Width="330px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="Gross Salary & Benefits">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="80px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="PF Contribution">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="PF Loan">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="IT">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="Salary Adv.">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="LWP">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="Total Deuction">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="70px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="Net Pay">
                                    <ItemStyle CssClass="ItemStylecssRight" Width="80px"></ItemStyle>
                                </asp:BoundField>
                            </Columns>
                        </asp:GridView>
                        <asp:GridView ID="grMovementDetls" runat="server" Width="940px" DataKeyNames="" AutoGenerateColumns="False"
                            Font-Size="9px" EmptyDataText="No Record Found" ShowFooter="true">
                            <HeaderStyle BackColor="#B3CDE4" Font-Bold="True" HorizontalAlign="center" Font-Size="10px"
                                Font-Names="Tahoma"></HeaderStyle>
                            <SelectedRowStyle BackColor="#D1DDF1" ForeColor="#333333" CssClass="ListHeader" Font-Bold="True">
                            ...
                            <AlternatingRowStyle BackColor="#EFF3FB"></AlternatingRowStyle>
                            <RowStyle Font-Size="10px" HorizontalAlign="right" Font-Names="Tahoma" />
                            <FooterStyle BackColor="#B3CDE4" Font-Bold="True" HorizontalAlign="right" Font-Size="10px"
                                Font-Names="Tahoma"></FooterStyle>
                            <Columns>
                                <asp:BoundField DataField="" HeaderText="Payroll SL#">
                                    <ItemStyle CssClass="ItemStylecss" Width="60px"></ItemStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="" HeaderText="Staff Name">
                                    <ItemStyle CssClass="ItemStylecss" Width="140px"></ItemStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Description">
                                    <ItemStyle Width="150px" HorizontalAlign="left" />
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDescrip" Text="" runat="server" Width="120px" TextMode="MultiLine"
                                            Rows="3"> </asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="" HeaderText="Gross Salary & Benefits">
                    ...
                    <div class="DivCommand1">
                        <div style="background-color: gray" class="DivCommandL">
                            <asp:Button ID="btnSaveAndApprove" runat="server" Text="Save & Approve" ForeColor="#3366CC"
                                Font-Bold="True" OnClick="btnSaveAndApprove_Click"></asp:Button>
                        </div>
                        <div class="DivCommandR">
                ...
                <cc1:ModalPopupExtender ID="ModalPopupTree" runat="server" TargetControlID="btnShowModal"
                    PopupControlID="PnlMove" Enabled="True" DynamicServicePath="" DropShadow="True"
