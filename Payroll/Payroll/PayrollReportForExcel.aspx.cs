...
public partial class Payroll_Payroll_PayrollReportForExcel : System.Web.UI.Page
{
    ...
    protected void GeneratePayrollReport()
    {
        ...
        foreach (DataRow dEmpRow in dtEmpPayroll.Rows)
        {
            ...
            nRow[3]="";
            nRow[4] = dEmpRow["LOCATIONNAME"].ToString().Trim();
            nRow[5] = dEmpRow["DEPTNAME"].ToString().Trim();
            nRow[6] = dEmpRow["JOBTITLE"].ToString().Trim();
            nRow[7] = dEmpRow["JoiningDate"].ToString().Trim();
    ...
    protected void FormatGridView(DataTable dtSalaryHead, int inBenefitHeadCount)
    {
        ...
        grPayroll.HeaderRow.Cells[4].Text = "Location";
        grPayroll.HeaderRow.Cells[5].Text = "Team";
