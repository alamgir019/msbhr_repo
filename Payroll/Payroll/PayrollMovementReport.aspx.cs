...
public partial class Payroll_Payroll_PayrollMovementReport : System.Web.UI.Page
{
    ...
    protected void CalculateMonthlySummaryDifference(GridView grv, string strMonth)
    {
        ...
        grPayrollSummary.FooterRow.Cells[3].Text = "Differ";
        grPayrollSummary.HeaderRow.Cells[3].Text = "";
        grPayrollSummary.HeaderRow.Cells[2].Text = "Payroll Month";
    ...
    protected void GeneratePayrollReport()
    {
        ...
        dtEmpPayroll = objPayRptMgr.GetPayrollData(ddlGeneratefor.SelectedValue.ToString(), strGenerateValue, ddlMonth.SelectedValue.ToString(),
    ...
    protected void GeneratePrevMonthPayrollReport()
    {
        ...
        dtEmpPayroll = objPayRptMgr.GetPayrollData(ddlGeneratefor.SelectedValue.ToString(), strGenerateValue, strPrevMonth, strPrevYear, ddlBank.SelectedValue.Trim());
    ...
    //                        strDate = objPayRptMgr.GetEmpJoinOrSeperateDate(gRow.Cells[1].Text.Trim(), "LeavingDate");
