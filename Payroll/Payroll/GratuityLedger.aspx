<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="GratuityLedger.aspx.cs" Inherits="Payroll_Payroll_GratuityLedger" Title="Gratuity Ledger" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="formStyle">
    <div id="formhead1">
      <div style="width:92%;float:left;">Gratuity Ledger Accrue</div>
    ...
    <div class="Div950" >
            ...
            <tr>
              ...
              <tr>
                  <td class="textlevel">
                      Last Accrue Date</td>
                  <td>
                      <asp:TextBox ID="txtLastAccrueDate" runat="server" Width="74px"></asp:TextBox>
                      <A href="javascript:NewCal('<%= txtLastAccrueDate.ClientID %>','ddmmyyyy')"><IMG style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px" height=16 alt="Pick a date" src="../../images/cal.gif" width=16 /></A>
                  </td>
                  <td class="textlevelshort">
                      Accrue Date</td>
                  <td>
                      <asp:TextBox ID="txtAccrueDate" runat="server" Width="74px"></asp:TextBox>
                      <A href="javascript:NewCal('<%= txtAccrueDate.ClientID %>','ddmmyyyy')"><IMG style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px" height=16 alt="Pick a date" src="../../images/cal.gif" width=16 /></A>
                  </td>
                  <td class="textlevelshort">
                  </td>
                  <td>
      ...
      <div style="margin-top:10px;">
        <fieldset>
          <div style="background-color:Gray;text-align:center;">
            ...
            <asp:Button ID="btnPrint" runat="server" Text="Print" onclientclick="printDiv('PrintMe')" Width="200px" OnClick="btnPrint_Click"/>
          </div>
          <div id="PrintMe" style="width:100%;margin-top:5px;"> <span style="font-size:16px;font-weight:bold;">Gratuity Ledger</span> <br />
            ...
            <asp:GridView id="grLedger" runat="server"  EmptyDataText="No Record Found" Font-Size="10px" Width="100%" AutoGenerateColumns="False"
                            DataKeyNames="EMPID,DESGID,PMONTH,PYEAR,CMONTH,CYEAR,ISEXIST,LEDGERID,CHARGINGAMT,PMONTHAMT">
      ...
      <div id="DivCommand1" style="padding-top:3px;">
        ...
        <div style="text-align:right;">
          <asp:Button ID="btnSave" runat="server" Text="Save Ledger" Width="120px"  UseSubmitBehavior="False" OnClick="btnSave_Click"  />
        </div>
      </div>
    </div>
  </div>
