<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="TrainingCategorySetup.aspx.cs" Inherits="Training_TrainingCategorySetup" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="officeSetup">
            ...
            <fieldset>
               ...
               <asp:HiddenField ID="hfIsUpdate" runat="server" />
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Category Name :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grList" runat="server" DataKeyNames="TrCategoryId" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TrCategoryName" HeaderText="Category Name">
