...
public partial class Training_TrainingSubTypeSetup : System.Web.UI.Page
{
    ...
    {
        dtList = objEmpMgr.TrainingSubTypeList();
       // dtList = objEmpMgr.SelectTrainNeedTypeList();
    ...
    private void SaveData(string IsDelete)
    {
        try
        {
            if (hfIsUpdate.Value == "Y")
                ...
                hfId.Value = Common.getMaxId("TrainingSubType", "TrainingSubTypeID");
            ...
            objEmpMgr.InsertTrainingSubType(objCommonSetup, hfIsUpdate.Value, IsDelete);
