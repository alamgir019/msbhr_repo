<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="Project.aspx.cs" Inherits="SOF_Project" Title="Project" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="officeSetup">
        ...
        <div style="margin: 2px; float: left; padding-right: 3px;">
           <a href="../../Default.aspx"><img src="../Images/close_icon.gif" /></a></div></div>
        <div class="MsgBox">
            <!--Div for msg-->
        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" CssClass="textlevel" Text="Project Code :"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtCode" runat="server" Width="300px"></asp:TextBox></td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Project Name :"></asp:Label></td>
                        <td>
        ...
        <div class="GridFormat1">
            <asp:GridView ID="grList" runat="server" DataKeyNames="ProjectId,IsActive" AutoGenerateColumns="False"
