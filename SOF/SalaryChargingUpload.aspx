<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="SalaryChargingUpload.aspx.cs" Inherits="SOF_SalaryChargingUpload" Title="Salary Charging Upload" %>
    ...
    <div id="PayrollConfigForm2" style="width: 90%;">
        ...
        <div style="margin-left: 10px; margin-right: 10px;">
            ...
            <fieldset style="margin-top: 10px;">
                <legend>Salary Charging List</legend>
                <div>
                    <asp:GridView ID="grList" runat="server" AutoGenerateColumns="true" ShowHeader="true"
