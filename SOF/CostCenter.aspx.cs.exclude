...
public partial class CostCenter : System.Web.UI.Page
{
    ...
    {
        dtList = objSOFMgr.SelectCostCenterList(0);
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMsg.Text = "Select a cost center first from the list then try to delete.";
        }
    ...
    protected void grList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            case ("DoubleClick"):
                txtCode.Text = Common.CheckNullString(grList.SelectedRow.Cells[1].Text);
                txtName.Text = Common.CheckNullString(grList.SelectedRow.Cells[2].Text);
