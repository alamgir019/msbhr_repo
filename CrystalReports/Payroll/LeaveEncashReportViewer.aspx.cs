...
public partial class CrystalReports_Payroll_LeaveEncashReportViewer : System.Web.UI.Page
{
    ...
    protected void GenerateReport(string strMonth, string strFinYear, string strEmpID)
    {
        ...
        ReportPath = Server.MapPath("~/CrystalReports/Payroll/rptLeaveEncashment.rpt");
        //this.PassParameter(Common.ReturnFullMonthName(strMonth));
        ReportDoc.Load(ReportPath);
        ReportDoc.SetDataSource(objGrMgr.GetLeaveEncashmentList(strMonth, strFinYear, strEmpID));
